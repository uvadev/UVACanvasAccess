...
namespace QuotaWatcher {
    internal static class Program {
        ...
        private const string WarningMessageTemplate = 
            ...
            "If you don't do this, some of your files may get deleted automatically if something ever needs to be uploaded to your account. If that happens, you won't be able to recover those files.\n\n" +
            "Thanks.\n\n" +
